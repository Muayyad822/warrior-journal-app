...
function MedicalReports() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-4xl mx-auto print:p-0"> {/* print:p-0 removes padding in print */}
      ...
      {/* Print/Export Button - Hidden during print */}
      <div className="mb-6 flex justify-end print:hidden">
        ...
        {/* For PDF export, a library like jsPDF or html2canvas would be integrated here */}
        {/* <button className="ml-2 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md shadow transition-colors">
          Download PDF
        </button> */}
      </div>

      {/* Report Content */}
      <div className="bg-white rounded-lg shadow-md p-6 print:shadow-none print:rounded-none print:p-0">
